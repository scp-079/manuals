...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fc4b2839a50191f0fe87d206521a89a04b3cdec62ae34fe250c51ee882eed127.js',function(){input.required=false;search();});}
